  ...
  try {
    const response = await fetch(OPENROUTER_API_URL, {
      ...
      headers: {
        ...
        'X-Title': 'Job Profile Aggregator',
      },
      body: JSON.stringify({
...
const constructSearchPrompt = (profile, searchConfig) => {
  return `Search for 20 relevant job opportunities based on the following candidate profile and preferences:
...
- Job Type: ${searchConfig.jobType}
- Experience Level: ${searchConfig.experienceLevel}
...
Ensure you provide exactly 20 job opportunities that are currently available and relevant.`;
};
